...
if st.session_state['box_session'] is not None:
    ...
    if st.session_state['sankey_session']:
        ...
        st.write(st.session_state['debtor_data'].style.format("{:.4}").apply(highlighther,subset = ['2024/01','2024/02','2024/03','2024/04','2024/05','2024/06']).apply(highlighther2,subset = ['2023H1','2023H2','YTD']))
        ## Show in webpage
