...
st.write(st.session_state['df'].apply(highlighther,subset = ['2024-01','2024-02','2024-03','2024-04','2024-05','2024-06'])\
         .apply(highlighther2,subset = ['2023H1','2023H2','YTD'])\
         .style.format("{:.4}",subset = ['2024-01','2024-02','2024-03','2024-04','2024-05','2024-06','2023H1','2023H2','YTD'])
        )
